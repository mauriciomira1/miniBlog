  ...
  function() {
    function t2(t3, e) {
      ...
      if (e >= 1e9)
        throw new D2(N2.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
      if (t3 < -62135596800)
        throw new D2(N2.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t3);
      if (t3 >= 253402300800)
        throw new D2(N2.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t3);
    }
  ...
  function(e) {
    ...
    n.fromServerFormat = function(t2) {
      for (var e2 = [], r = "", i = 0, o = function() {
        if (0 === r.length)
          throw new D2(N2.INVALID_ARGUMENT, "Invalid field path (" + t2 + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
        e2.push(r), r = "";
      }, s = false; i < t2.length; ) {
        var u = t2[i];
        if ("\\" === u) {
          if (i + 1 === t2.length)
            throw new D2(N2.INVALID_ARGUMENT, "Path has trailing escape character: " + t2);
          var a = t2[i + 1];
          if ("\\" !== a && "." !== a && "`" !== a)
            throw new D2(N2.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t2);
          r += a, i += 2;
        } else
          "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
      }
      if (o(), s)
        throw new D2(N2.INVALID_ARGUMENT, "Unterminated ` in path: " + t2);
      return new n(e2);
    }, n.emptyPath = function() {
      return new n([]);
    }, n;
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (G(n2) !== G(r))
          return false;
        for (var i in n2)
          if (n2.hasOwnProperty(i) && (void 0 === r[i] || !ft(n2[i], r[i])))
            return false;
        return true;
      }(t2, e);
    default:
...
function _t(t2) {
  ...
  if (t2.arrayValue) {
    for (var n = {
      ...
      n.arrayValue.values[r] = _t(t2.arrayValue.values[r]);
    return n;
  }
  ...
  function() {
    ...
    t2.prototype.field = function(t3) {
      ...
      for (var e = this.value, n = 0; n < t3.length - 1; ++n)
        if (!Tt(e = (e.mapValue.fields || {})[t3.get(n)]))
          return null;
...
function Ct(t2, e) {
  ...
  for (var n = 0; n < t2.orderBy.length; n++)
    if (!Gt(t2.orderBy[n], e.orderBy[n]))
      return false;
  if (t2.filters.length !== e.filters.length)
    return false;
  for (var r = 0; r < t2.filters.length; r++)
    if (i = t2.filters[r], o = e.filters[r], i.op !== o.op || !i.field.isEqual(o.field) || !ft(i.value, o.value))
      return false;
  var i, o;
...
function Qt(t2, e, n) {
  for (var r = 0, i = 0; i < t2.position.length; i++) {
    ...
    if (r = o.field.isKeyField() ? ct.comparator(ct.fromName(s.referenceValue), n.key) : dt(s, n.data.field(o.field)), "desc" === o.dir && (r *= -1), 0 !== r)
      break;
  }
...
function zt(t2, e) {
  ...
  for (var n = 0; n < t2.position.length; n++)
    if (!ft(t2.position[n], e.position[n]))
      return false;
  return true;
}
var Wt = (
  ...
  function() {
    function t2(t3, e, n, r) {
      ...
      for (var i = 1; !t3.isEmpty(); )
        if (i = e ? n(t3.key, e) : 1, // flip the comparison if we're going in reverse
        r && (i *= -1), i < 0)
    ...
    t2.prototype.rt = function(t3) {
      ...
      if (r) {
        ...
        if (xt(i))
          ...
          this.ct(e) !== n && // Existence filter mismatch: We reset the mapping and raise a new
...
function An(t2, e) {
  ...
  if (n.get(1) !== t2.databaseId.projectId)
    throw new D2(N2.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t2.databaseId.projectId);
  if (n.get(3) !== t2.databaseId.database)
    throw new D2(N2.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t2.databaseId.database);
  return new ct(Rn(n));
}
function kn(t2, e) {
  ...
  var n = e.currentDocument ? function(t3) {
    ...
    return function(t3, e3) {
      ...
      if ("setToServerValue" in e3)
        P2("REQUEST_TIME" === e3.setToServerValue), n2 = new me();
        ...
        "increment" in e3 ? n2 = new Te(t3, e3.increment) : O2();
...
function Xn(t2) {
  for (var e = "", n = 0; n < t2.length; n++)
    e.length > 0 && (e = Zn(e)), e = Jn(t2.get(n), e);
  return Zn(e);
}
function Jn(t2, e) {
...
function tr(t2) {
  var e = t2.length;
  if (P2(e >= 2), 2 === e)
    return P2("" === t2.charAt(0) && "" === t2.charAt(1)), H2.emptyPath();
...
function Mr(t2, e) {
  if (e.document)
    return On(t2.Lt, e.document, !!e.hasCommittedMutations);
  if (e.noDocument) {
...
function pi(t2) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(e) {
      if (t2.code !== N2.FAILED_PRECONDITION || t2.message !== gr)
        throw t2;
    ...
    t2.prototype.delete = function(t3) {
      ...
      for (var r = 0; r < n.length; r++)
        if (this.equalsFn(n[r][0], t3))
          return 1 === n.length ? delete this.inner[e] : n.splice(r, 1), true;
      return false;
    }, t2.prototype.forEach = function(t3) {
  ...
  function() {
    ...
    t2.prototype.Ee = function(t3, e) {
      ...
      return Ni(t3).$t({
        ...
        for (var s = ct.fromSegments(t4); o && ct.comparator(o, s) < 0; )
    ...
    t2.prototype.fn = function() {
      ...
      return this.Be.runTransaction(t3, o, mr, function(o2) {
        return i = new xr(o2, r.Ne ? r.Ne.next() : S2.o), "readwrite-primary" === e ? r.Je(i).next(function(t4) {
          ...
          if (!e2)
            throw x2("Failed to obtain primary lease for action '" + t3 + "'."), r.isPrimary = false, r.Se.enqueueRetryable(function() {
              return r.Me(false);
...
function Zi(t2, e, i, o) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          for (n = F2(t2), s = sn(), u = Ze(), a = rn(), c = 0, h = i; c < h.length; c++)
...
var go = (
  ...
  function() {
    ...
    return t2.Vs = function(e, n) {
      for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = an(), s = 0; i && s < r.activeTargetIds.length; ++s)
              ...
              if (this.started) {
                if (null !== i.key) {
                  if (this.Ls.test(i.key)) {
                    ...
                    if (null !== i.newValue && (n = this.si(i.key, i.newValue)))
                      return [2, this.ii(n)];
                  } else if (this.qs.test(i.key)) {
                    if (null !== i.newValue && (o = this.ri(i.key, i.newValue)))
                      return [2, this.oi(o)];
                  } else if (i.key === this.Us) {
                    if (null !== i.newValue && (s = this.js(i.newValue)))
                      return [2, this.Ws(s)];
  ...
  function(e) {
    ...
    function() {
      ...
      t2.prototype.ki = function(t3, e) {
        ...
        t3["Content-Type"] = "text/plain", this.databaseInfo.appId && (t3["X-Firebase-GMPID"] = this.databaseInfo.appId), e)
    ...
    return __extends(n, e), n.prototype.wr = function(t2) {
      ...
      var e2 = function(t3, e3) {
        ...
        if ("targetChange" in e3) {
          ...
          e3.documentDelete, (r = e3.documentDelete).document, i = An(t3, r.document), o = r.readTime ? En(r.readTime) : K2.min(), u = Nt.newNoDocument(i, o), s = r.removedTargetIds || [], n3 = new fn([], s, u.key, u);
        else if ("documentRemove" in e3)
          e3.documentRemove, (r = e3.documentRemove).document, i = An(t3, r.document), o = r.removedTargetIds || [], n3 = new fn([], o, i, null);
        else {
          if (!("filter" in e3))
            return O2();
          e3.filter;
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        ...
        case 5:
          return [3, 13];
        case 6:
          if (e instanceof fn ? t2.qr.X(e) : e instanceof ln ? t2.qr.rt(e) : t2.qr.et(e), i.isEqual(K2.min()))
            return [3, 13];
          a.label = 7;
        case 7:
...
function rs(t2) {
  return __awaiter(this, void 0, void 0, function() {
    var e, n, i, o;
    return __generator(this, function(r) {
      for (e = as(t2), n = 0, i = t2.Fr; n < i.length; n++)
...
function hs(t2, e) {
  if (x2("AsyncQueue", e + ": " + t2), Nr(t2))
    return new D2(N2.UNAVAILABLE, e + ": " + t2);
  throw t2;
}
var fs = (
  /** @class */
...
var ds = (
  ...
  function() {
    ...
    return t2.fromInitialDocuments = function(e, n, r, i) {
      ...
      if (!(this.fromCache === t3.fromCache && this.syncStateChanged === t3.syncStateChanged && this.mutatedKeys.isEqual(t3.mutatedKeys) && ie(this.query, t3.query) && this.docs.isEqual(t3.docs) && this.oldDocs.isEqual(t3.oldDocs)))
        return false;
...
function vs(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          if (n = F2(t2), i = e.query, o = false, (s = n.queries.get(i)) || (o = true, s = new ps()), !o)
            return [3, 4];
          r.label = 1;
        case 1:
                ...
                switch (r.label) {
                  ...
                  case 4:
                    for (o2 = 0, s2 = e2; o2 < s2.length; o2++)
                      u2 = s2[o2], a2 = u2.targetId, u2.fromCache || (c2 = n.kn.get(a2), h = c2.snapshotVersion, f = c2.withLastLimboFreeSnapshotVersion(h), // Advance the last limbo free snapshot version
...
function Uu(t2, e, n) {
  if (!n)
    throw new D2(N2.INVALID_ARGUMENT, "Function " + t2 + "() cannot be called with an empty " + e + ".");
}
function Bu(t2, e) {
  if (void 0 === e)
    return {
  ...
  if (void 0 !== e.mergeFields && void 0 !== e.merge)
    throw new D2(N2.INVALID_ARGUMENT, "Invalid options passed to function " + t2 + '(): You cannot specify both "merge" and "mergeFields".');
  return e;
}
function ju(t2, e, n, r) {
  if (true === e && true === r)
    throw new D2(N2.INVALID_ARGUMENT, t2 + " and " + n + " cannot be used together.");
}
function Ku(t2) {
  if (!ct.isDocumentKey(t2))
    throw new D2(N2.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t2 + " has " + t2.length + ".");
}
function Gu(t2) {
  if (ct.isDocumentKey(t2))
    throw new D2(N2.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t2 + " has " + t2.length + ".");
}
function Qu(t2) {
  if (void 0 === t2)
    return "undefined";
...
function Wu(t2, e) {
  if (e <= 0)
    throw new D2(N2.INVALID_ARGUMENT, "Function " + t2 + "() requires a positive number, but it was: " + e + ".");
}
var Hu = (
  /** @class */
  function() {
...
function Zu(t2, n) {
  for (var r, i = [], o = 2; o < arguments.length; o++)
    i[o - 2] = arguments[o];
  if (t2 = getModularInstance(t2), Uu("collection", "path", n), t2 instanceof Yu)
    return Gu(r = H2.fromString.apply(H2, __spreadArray([n], i))), new Ju(
      t2,
      /* converter= */
      null,
      r
    );
  if (!(t2 instanceof $u || t2 instanceof Ju))
...
function ta2(t2, n) {
  ...
  // 'undefined' and 'null'.
  1 === arguments.length && (n = V2.u()), Uu("doc", "path", n), t2 instanceof Yu)
    return Ku(r = H2.fromString.apply(H2, __spreadArray([n], i))), new $u(
      t2,
      /* converter= */
      null,
      new ct(r)
  ...
  function() {
    function t2(t3, e) {
      if (!isFinite(t3) || t3 < -90 || t3 > 90)
        throw new D2(N2.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t3);
...
var Ea = (
  ...
  function(e) {
    ...
    return __extends(n, e), n.prototype._toFieldTransform = function(t2) {
      if (2 !== t2.Nc)
        throw 1 === t2.Nc ? t2.Lc(this._methodName + "() can only appear at the top level of your update data") : t2.Lc(this._methodName + "() cannot be used with set() unless you pass {merge:true}");
...
function xa2(t2, e, n, r, i, o) {
  ...
  for (var h = [], f = Et.empty(), d = u.length - 1; d >= 0; --d)
    if (!Ba(h, u[d])) {
      var p2 = u[d], y2 = a[d];
...
function Xa2(t2) {
  if (Xt(t2) && 0 === t2.explicitOrderBy.length)
    ...
    return __extends(n, e), n.prototype._apply = function(t2) {
      var e2 = Ta(t2.firestore), n2 = function(t3, e3, n3, r, i, o, s) {
        ...
        if (i.isKeyField()) {
          ...
          "in" !== o && "not-in" !== o && "array-contains-any" !== o || uc2(s, o), u = Ra2(
            n3,
            "where",
            s,
            /* allowArrays= */
...
function mc2(t2) {
  ...
  if (t2 instanceof $u)
    f = zu(t2.firestore, ua2), d = Yt(t2._key.path), h = {
      next: function(e2) {
        s[c] && s[c](wc2(f, t2, e2));
      },
      error: s[c + 1],
    ...
    return Object.defineProperty(t2.prototype, "_databaseId", {
      ...
      try {
        return new Mc2(this, function(t4, e) {
          if (t4 = zu(t4, Yu), Uu("collectionGroup", "collection id", e), e.indexOf("/") >= 0)
